...
class KkangGetXRx extends StatelessWidget {
  const KkangGetXRx({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        body: KkangGetXRxMyWidget(),
      ),
    );
  }
}

class KkangGetXRxMyWidget extends StatelessWidget {
  const KkangGetXRxMyWidget({super.key});
