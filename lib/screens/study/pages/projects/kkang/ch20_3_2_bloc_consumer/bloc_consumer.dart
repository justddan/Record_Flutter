...
class KkangBlocConsumer extends StatelessWidget {
  const KkangBlocConsumer({super.key});
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          title: Text("Bloc Consumer/Repository Test"),
        ),
        body: RepositoryProvider(
          create: (context) => MyRepository(),
          child: BlocProvider<BlocCounter>(
            create: (context) => BlocCounter(),
            child: KkangBlocConsumerMyWidget(),
          ),
        ),
      ),
    );
...
class KkangBlocConsumerMyWidget extends StatelessWidget {
  const KkangBlocConsumerMyWidget({super.key});
