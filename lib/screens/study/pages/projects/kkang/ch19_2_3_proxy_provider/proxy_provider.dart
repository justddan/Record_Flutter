...
class KkangProxyProvider extends StatelessWidget {
  const KkangProxyProvider({super.key});
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        body: MultiProvider(
          ...
          child: KkangProxyProviderSubWidget(),
        ),
      ),
    );
  }
...
class KkangProxyProviderSubWidget extends StatelessWidget {
  const KkangProxyProviderSubWidget({super.key});
